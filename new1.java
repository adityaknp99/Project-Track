...
class new1
{
	...
	public static void main(String ar[])
	{
		...
		/*arr[1][0]=arr[1][1]=2;arr[0][3]=arr[1][2]=arr[1][3]=4;
		print(arr);
		System.out.println();
		//down(arr);
		//left(arr);
		right(arr);
		System.out.println();
		fill(arr);print(arr);System.out.println();
		up(arr);System.out.println();
		fill(arr);print(arr);System.out.println();
		down(arr);System.out.println();
		fill(arr);print(arr);System.out.println();
		*/
	}
}
